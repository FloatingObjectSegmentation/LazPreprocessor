...
namespace Tests
{
    class UndergroundTest : Test
    {

        private new static string TEST_SUBSUBDIR = Path.Combine(TESTS_SUBDIR, "underground_test");

        static List<AugmentableObjectSample> samples = new List<AugmentableObjectSample>();
        static string workdir = Path.Combine(TESTS_SUBDIR, TEST_SUBSUBDIR);
